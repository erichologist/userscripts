// ==UserScript==
// @name         AI-UX-Customizer v2
// @downloadURL  https://github.com/erichologist/userscripts/raw/refs/heads/main/userjs/ai-ux-customizer-v2.user.js
// @version      v2
// @license      MIT
...
(() => {
   ...
   * Keys are derived dynamically using APPID to prevent collisions. */
    const CSS_VARS = {
        ...
        USER_BUBBLE_WEBKITBDFILTER: `--${APPID}-user-bubble-webkitbackdropfilter`,
        ...
        INPUT_WEBKITBDFILTER: `--${APPID}-input-webkitbackdropfilter`,
            ...
            ChatGPT: {
                ...
                features: {
                    ...
                    fixed_nav_console: {
                        ...
                        keyboard_shortcuts: { enabled: false },
                    },
                },
                defaultSet: {
                    assistant: {
                        ...
                        textColor: null,
                        font: 'Nova Mona',
                        bubbleBackgroundColor: 'rgb(13 13 13 / 0.85)',
                        bubblePadding: 21,
                    ...
                    user: {
                        ...
                        textColor: 'rgb(0 0 0)',
                        font: null,
                        bubbleBackgroundColor: 'rgb(255 255 255 / 0.4)',
                        bubblePadding: 8,
                        bubbleBorderRadius: 10,
                        bubbleMaxWidth: null,
                        standingImageUrl: null,
    ...
    const CONFIG_SCHEMA = {
        // ============================================================
        // THEME SCOPE
        // Used by ThemeModal and ThemeManager. 
        // Paths are relative to the theme object root.
        // ============================================================
        theme: {
            // --- Numeric Fields ---
            ...
            'user.bubbleBoxShadow': {
                type: 'color',
                ui: { label: 'Bubble box shadow:', tooltip: 'Box Shadow for the chat bubble.' },
            },
            'user.bubbleBackdropFilter': {
                type: 'color',
                ui: { label: 'Bubble backdrop filter:', tooltip: 'Bubble backdrop filter blur, ex: blur(6px)' },
            },
            'assistant.textColor': {
                type: 'color',
            ...
            'inputArea.boxShadow': {
                type: 'color',
                ui: { label: 'Input box shadow:', tooltip: 'Box Shadow for the Input Area.' },
            },
            'inputArea.backdropFilter': {
                type: 'number',
                ui: { label: 'Input backdrop filter:', tooltip: 'Input Area backdrop filter blur, ex: blur(6px)' },
            },
            'inputArea.textColor': {
                type: 'color',
 ...
 // --- Select Fields (Window Background) ---
        ...
        // ============================================================
        // PLATFORM SCOPE
        // Used by SettingsPanel and Platform Adapters. 
        // Paths are relative to `platforms.${PLATFORM}.`.
        // ============================================================
        platform: {
            // --- Options ---
            'options.icon_size': {
...
pre>code>span, code>span, pre>code, pre, code { font-family:'Nova Mono', NovaMono, monospace !important; }
html,body {
	font-family: "Nova Mono", NovaMono, monospace !important;}
.flex.h-svh.w-screen.flex-col {
	font-family:'Nova Mono', 'NovaMono', monospace !important;
	padding:1vh 1vw 5vh 1vw !important;
	width:100% !important;
	font-size:80%;
	max-height:100vh !important;
}
 :is(.ͼt,.ͼn,.ͼr,.ͼq,.ͼu,.ͼv,.ͼs){font-family:'Nova Mono', 'NovaMono', monospace !important;}
 ...
 :is(.ͼt){color:#BC80FF !important; text-shadow:0 0 0.1em #5972FF, 0 0 2px #FFF6, 0 -.1px 3px #3E0A74, 0 0 4px #FFF6, 0 -1px 4px #CF3BE7, 0 1px 4px #FFF4, 0 0 .5em #00F !important;}
 ...
 :is(.ͼq), code {color:#03e9f4 !important; text-shadow:0 0 0 #FFF, 0 0 5px #0F07FF60, 0 -0.1px 3.5px #00E95260, 0 0 8px #5E60CE60, 0 -1px 9px #0F07FF60, 0 1px 8px #3457D560, 0 0 4px #00D9E060 !important;}
...
div>:is(div.bg-token-bg-primary.dark:bg-token-bg-elevated-primary.corner-superellipse/1.1.cursor-text.overflow-clip.bg-clip-padding.p-2.5.contain-inline-size.motion-safe:transition-colors.motion-safe:duration-200.motion-safe:ease-in-out.grid.grid-cols-[auto_1fr_auto].[grid-template-areas:'header_header_header'_'leading_primary_trailing'_'._footer_.'].group-data-expanded/composer:[grid-template-areas:'header_header_header'_'primary_primary_primary'_'leading_footer_trailing'].shadow-short-composer),
div.bg-token-bg-primary.dark:bg-token-bg-elevated-primary.corner-superellipse/1.1.cursor-text.overflow-clip.bg-clip-padding.p-2.5.contain-inline-size.motion-safe:transition-colors.motion-safe:duration-200.motion-safe:ease-in-out.grid.grid-cols-[auto_1fr_auto].[grid-template-areas:'header_header_header'_'leading_primary_trailing'_'._footer_.'].group-data-expanded/composer:[grid-template-areas:'header_header_header'_'primary_primary_primary'_'leading_footer_trailing'].shadow-short-composer
div.bg-token-bg-primary.dark:bg-token-bg-elevated-primary.corner-superellipse/1.1.cursor-text.overflow-clip.bg-clip-padding.p-2.5.contain-inline-size.motion-safe:transition-colors.motion-safe:duration-200.motion-safe:ease-in-out.grid.grid-cols-[auto_1fr_auto].[grid-template-areas:'header_header_header'_'leading_primary_trailing'_'._footer_.'].group-data-expanded/composer:[grid-template-areas:'header_header_header'_'primary_primary_primary'_'leading_footer_trailing'].shadow-short-composer:has(>.[grid-area:leading]),
div.bg-token-bg-primary.dark:bg-token-bg-elevated-primary.corner-superellipse/1.1.cursor-text.overflow-clip.bg-clip-padding.p-2.5.contain-inline-size.motion-safe:transition-colors.motion-safe:duration-200.motion-safe:ease-in-out.grid.grid-cols-[auto_1fr_auto].[grid-template-areas:'header_header_header'_'leading_primary_trailing'_'._footer_.'].group-data-expanded/composer:[grid-template-areas:'header_header_header'_'primary_primary_primary'_'leading_footer_trailing'].shadow-short-composer:has(>div.[grid-area:leading]),
div:has(>div.[grid-area:leading]),
div.bg-token-bg-primary.dark:bg-token-bg-elevated-primary.corner-superellipse/1.1.cursor-text.overflow-clip.bg-clip-padding.p-2.5.contain-inline-size.motion-safe:transition-colors.motion-safe:duration-200.motion-safe:ease-in-out.grid.grid-cols-[auto_1fr_auto].[grid-template-areas:'header_header_header'_'leading_primary_trailing'_'._footer_.'].group-data-expanded/composer:[grid-template-areas:'header_header_header'_'primary_primary_primary'_'leading_footer_trailing'].shadow-short-composer {
	background:none !important;
	background-color: rgba(255,255,255,.15) !important;
	box-shadow:inset 0 0 1px .4px rgba(255,255,255,.25), 0 5px 30px rgba(0,0,0,0.2), inset 0 5px 23px rgba(255,255,255,.1), inset 0 0 12px rgba(255,255, 255,.15) !important;
}
`;
