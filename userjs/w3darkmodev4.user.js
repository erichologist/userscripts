 ...
 *, .darktheme, .darktheme input, .darktheme .CodeMirror-line {font-family: NovaMono, monospace !important; caret-color:#FF057B !important;}
input:focus  {outline: none; border-color: #0000ffaa !important; box-shadow: 0 0 5px #0000FF !important;}
.darktheme input:focus  {outline: none; border-color: #FF057Baa !important; box-shadow: 0 0 5px #FF057B !important;}
[contenteditable="true"] {caret-color:#FF057B !important;}
...
.darktheme .bigbtn{background-color:#234254!important;color:#E6DFD6!important;border-width:0!important;}
...
.darktheme .w3-border .w3-button{background-color:#062D43!important;color:#E6DFD6!important;border-width:0}
.darktheme .w3-border .w3-button:hover{background-color:#234254!important;color:#DACFD2!important;border-width:0}
...
.darktheme .w3-border, .w3-border{border:0!important;}
...
.darktheme .tut_overview, .tut_overview{background-color:#062D43!important;}
.darktheme .topnav, .topnav{background-color:#052134!important;}
.darktheme .topnav .w3-row-padding .w3-bar-item, .topnav .w3-row-padding .w3-bar-item{background-color:#052134!important;color:#E6DFD6!important;}
.darktheme .topnav .w3-row-padding .w3-bar-item:hover, .topnav .w3-row-padding .w3-bar-item:hover{background-color:#062D43!important;color:#DACFD2!important;}
.darktheme .topnav .w3-row-padding .w3-bar-item:focus{background-color:#062D43!important;color:#DACFD2!important;}
.topnav .w3-row-padding .w3-bar-item:focus{background-color:#062D43!important;color:#DACFD2!important;}
.darktheme .topnav .w3-bar, .topnav .w3-bar{background-color:#062D43!important;}
.darktheme .topnav .w3-bar-item, .topnav .w3-bar-item{background-color:#062D43!important;color:#E6DFD6!important;}
.darktheme .topnav .w3-bar-item:hover, .topnav .w3-bar-item:hover{background-color:#052134!important;color:#DACFD2!important;}
.darktheme .topnav .w3-bar-item:focus, .topnav .w3-bar-item:focus{background-color:#052134!important;color:#DACFD2!important;}
.darktheme .top, .top{background-color:#052134!important;color:#E6DFD6!important;}
.darktheme .sidesection, .sidesection{background-color:#062D43!important;color:#E6DFD6!important;}
.darktheme .login, .login{color:#052134!important;}
.darktheme .exercisewindow, .exercisewindow{background-color:#052134!important;color:#E6DFD6!important;}
.darktheme .exerciseprecontainer, .exerciseprecontainer{background-color:#062D43!important;color:#E6DFD6!important;}
.darktheme .bigbtn, .bigbtn{background-color:#234254!important;color:#E6DFD6!important;border-width:0!important;}
.darktheme .bigbtn:hover, .bigbtn:hover{background-color:#000!important;color:#DACFD2!important;}
.darktheme .active_overview, .active_overview{background-color:#062D43!important;color:#E6DFD6!important;}
...
.darktheme ::-webkit-scrollbar-button,::-webkit-scrollbar-button{background-color:#062D43;box-shadow:0 0 10px rgba(0,0,0,.14),-1.5px -2px 1px rgba(160,160,160,0.2),2px 1px 8px rgba(0,0,0,0.12)!important;}
body.darkpagetheme #main,body.darkpagetheme{background-color:#20242c!important;}
.w3-panel > .ws-note, .w3-panel .ws-note,div.w3-panel.ws-note,body.darkpagetheme .ws-note,* .ws-note, .ws-note{color:#E6DFD6!important;background-color:#003358!important;box-shadow:0 0 10px rgba(0,0,0,.14),inset 1.5px 1px 15px rgba(160,160,160,0.08),-2px -2px 8px rgba(0,0,0,0.12),inset -1.5px -1px 15px #00000020!important;}
.darktheme .w3-border .w3-button, .w3-border .w3-button, .darktheme .w3-btn, .darktheme .ws-btn, .ws-btn, .w3-btn, .nextprev a.w3-right, .nextprev a.w3-left, .nextprev a.w3-right, .nextprev a.w3-left .w3-btn{background-color:#00375E!important;color:#e2e0e0!important;border-color:#0000!important;box-shadow:0 0 12px rgba(0,0,0,.1),-1.5px -.9px 5px rgba(160,160,160,0.09),2px 1px 8px rgba(0,0,0,0.09)!important;}
.darktheme .w3-border .w3-button:hover, .w3-border .w3-button:hover{background-color:#062D43!important;color:#DACFD2!important;border-width:0}
.darktheme .ws-btn:visited, .ws-btn:visited, .darktheme .ws-btn:link, .ws-btn:link, .darktheme .w3-btn:visited, .w3-btn:visited, .darktheme .w3-btn:link, .w3-btn:link{background-color:#004973!important;color:#E6DFD6!important;border-width:0;}
.darktheme .ws-btn:hover, .ws-btn:hover, .darktheme .ws-btn:active, .ws-btn:active, .darktheme .w3-btn:hover, .w3-btn:hover, .darktheme .w3-btn:active, .w3-btn:active{background-color:#062D43!important;color:#eeeeee!important;border-width:0;box-shadow:inset -1.5px -.9px 10px rgba(160,160,160,0.09),inset 2px 1px 10px rgba(0,0,0,0.1)!important;}
.darktheme .mainLeaderboard, .mainLeaderboard, #mainLeaderboard, .darktheme #mainLeaderboard {background-color:#001B29!important;}
...
.darktheme .topnav .w3-row-padding .w3-bar-item:hover{background-color:#062D43!important;color:#DACFD2!important;}
.darktheme .topnav .w3-row-padding .w3-bar-item:focus{background-color:#062D43!important;color:#DACFD2!important;}
.darktheme .topnav .w3-bar, .darktheme .topnav .w3-bar-item {background-color:#062D43!important;}
.darktheme .topnav .w3-bar-item {color:#E6DFD6!important;}
.darktheme .topnav .w3-bar-item:hover {background-color:#052134!important;color:#DACFD2!important;}
.darktheme .topnav .w3-bar-item:focus {background-color:#052134!important;color:#DACFD2!important;}
.darktheme .top {background-color:#052134!important;color:#E6DFD6!important;}
.darktheme .sidesection {background-color:#062D43!important;color:#E6DFD6!important;}
...
.darktheme ::-webkit-scrollbar {background-color:#052134;}
.darktheme ::-webkit-scrollbar-thumb {background-color:#00D1C980;}
.darktheme ::-webkit-scrollbar-button {background-color:#062D43;box-shadow:0 0 10px rgba(0,0,0,.14),-1.5px -2px 1px rgba(160,160,160,0.2),2px 1px 8px rgba(0,0,0,0.12)!important;}
.darktheme body #main{background-color:#20242c!important;}
.darktheme .nextprev a.w3-left, .darktheme .nextprev a.w3-right, .darktheme .nextprev a.w3-left .w3-btn, .darktheme .w3-btn:link, .darktheme .w3-btn:visited {background-color:#073b4c!important;color:#e2e0e0!important;border-color:#0000!important;box-shadow:0 0 12px rgba(0,0,0,.1),-1.5px -.9px 5px rgba(160,160,160,0.09),2px 1px 8px rgba(0,0,0,0.09)!important;}
...
.darktheme .w3-example, .w3-example{color:#E6DFD6!important;background-color:#062D43!important;border-color:#052134!important;border-right-color:#001B29!important;border-radius:10px!important;border-bottom-left-radius:10px!important;border-bottom-right-radius:10px!important;border-top-left-radius:10px!important;border-top-right-radius:10px!important;box-shadow:0 0 15px rgba(0,0,0,.15),inset 1.5px 1px 15px #001B2940,-2px -2px 8px rgba(0,0,0,0.12)!important;}
.darktheme mark.rh-1767713930591, .darktheme .w3-code, .darktheme .w3-section {border-right-color:#001B29!important;border-radius:10px!important;border-top-left-radius:10px!important;border-bottom-left-radius:10px!important;border-top-right-radius:10px!important;border-bottom-right-radius:10px!important;box-shadow:0 0 15px rgba(0,0,0,.15),inset 1.5px 1px 15px #001B2940,-2px -2px 8px rgba(0,0,0,0.12)!important;border-color:#052134!important;}
...
.darktheme span.csspropertyvaluecolor, .darktheme .csspropertyvaluecolor, .csspropertyvaluecolor {color:#0EDDFF!important;text-shadow:none!important;}
...
body.darkpagetheme>code.w3-codespan,body.darkpagetheme>code.w3-codespan:has(>a), .darktheme .w3-codespan, .darkpagetheme>.w3-codespan, .darkpagetheme>.w3-codespan:has(>a), .darktheme p>code, .darktheme p>code.w3-codespan:has(>a), .darktheme code:has(>a) {color:#0EFFEE!important;background:none!important;border:none!important;border-color:none!important;border-left-color:none!important;border-bottom-color:none!important;border-top-color:none!important;border-right-color:none!important;box-shadow:none!important;text-shadow:0 0 3.4px #01202C,0 0 2px #00335880,0 0 3px #0EFFEE66,0 0 3.4px #000!important;font-family:Menlo,Monoflow,Monotalic-NarrowLight,Monotalic-Narrow,monospace!important;}
`
